...
from torch.autograd import Variable as V  # Variable 已不再需要
...
from networks.Diffdlinknet_v6 import LinkNet34, DinkNet34, DinkNet50, DinkNet101, DinkNet34_less_pool
...
solver.load('weights/log18_dink34.th')
tic = time()
target = 'submits/log18_dink34/'
